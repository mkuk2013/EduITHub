...
export function PythonLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
...
export function WordPressLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function ReactLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function NodeLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function MongoLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function PostgresLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function JavaScriptLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function HTML5Logo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function CSS3Logo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function PhotoshopLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function IllustratorLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function PremiereProLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function AfterEffectsLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function FigmaLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function WindowsLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function LinuxLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function AIBrainLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function MarketingLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
...
export function SEOLogo({ className = "h-8 w-8", ...props }: { className?: string; [key: string]: any }) {
  return (
    // eslint-disable-next-line @next/next/no-img-element
